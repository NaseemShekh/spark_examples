...
console.log('Base Url: '+basePackageUri);
...
scene.root.on("onKeyDown", function(e) {
  ...
  var textbg = scene.create({t:"image",a:0, x:randomInt(50,scene.getWidth()-150),
                                  ...
                                  url:basePackageUri+"/img/cracle.jpg",
...
var whiteBalloon = scene.create({t:"imageResource", url:basePackageUri+"/img/flixfling.jpg"});
var blueBalloon = scene.create({t:"imageResource", url:basePackageUri+"/img/hungama.jpg"});
var redBalloon = scene.create({t:"imageResource", url:basePackageUri+"/img/iheart.jpg"});
